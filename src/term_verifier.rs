...
fn main() {
    ...
    let mut f = File::create(Path::new(&format!("out/{}", coq_gen.name)).with_extension("v"))
                     .expect("could not create the generated Coq file");
    write!(f, "{}", output).expect("could not write to the generated Coq file");
    println!("Generated a proof of the validity of the given terms at: {}.v", coq_gen.name);
}
/* [[IGNORE */
}
/* IGNORE]] */
